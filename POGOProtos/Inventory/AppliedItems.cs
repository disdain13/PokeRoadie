...
namespace POGOProtos.Inventory {
  ...
  public sealed partial class AppliedItems : pb::IMessage<AppliedItems> {
    ...
    private readonly pbc::RepeatedField<global::POGOProtos.Inventory.AppliedItem> ItemId = new pbc::RepeatedField<global::POGOProtos.Inventory.AppliedItem>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ItemId.WriteTo(output, _repeated_item_codec);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int CalculateSize() {
      int size = 0;
      size += ItemId.CalculateSize(_repeated_item_codec);
      return size;
    }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 34: {
            ItemId.AddEntriesFrom(input, _repeated_item_codec);
            break;
          }
        }
      }
